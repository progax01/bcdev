...
console.log(web3Instance);
          ...
          console.log("asdf", accountBalance)
          setBalance(web3Instance.utils.fromWei(accountBalance, "ether"));

          const tokenContractAddress =
            "0x4b7A6CA413f95CC81F627DC688673f693181d7Fc"; // Replace with your token contract's address
...
console.log("new new")
    try {
      ...
      const num = parseInt(amountInWei);
      console.log("test amount", amountInWei);
      console.log(typeof(Number(num)));
   

      const transaction = await tokenContract.methods.transfer(recipientAddress, num).send({ from: account, gas:50000 });

      console.log("trans",transaction);
console.log("transaction in process")
setTransactionStatus("Completed");
      setTransactionHash(transaction.transactionHash);
      console.log.apply(setTransactionHash);
    } catch (error) {
  ...
  return (
    <div>
      ...
      <div className="gap-2">
        ...
        {transactionStatus === "Processing" && <p>Transaction is processing...</p>}
