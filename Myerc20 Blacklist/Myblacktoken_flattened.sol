...
contract Myblacktoken is ERC20, Ownable {
    ...
    function buyTokens(uint256 amount) external payable  onlyNotBlacklisted returns (string memory) {
       uint tprice=10 wei;
    ...
    function transfer(address to, uint256 amount) external onlyNotBlacklisted override returns (bool) {
        require(
